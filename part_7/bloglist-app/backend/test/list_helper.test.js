...
describe('Blog tests', () => {
  ...
  test('there are 1 blog posts', async() => {
  ...
  test('HTTP POST successfully creates a new blog post if token is valid', async() => {
    const newBlog = {
      title: 'new test blog',
      author: 'John Doe',
  ...
  test('if the likes property is missing, likes is set to 0', async() => {
  ...
  test('if title is missing, status code is 400', async() => {
  ...
  test('if url is missing, status code is 400', async() => {
...
describe('User tests', () => {
  ...
  test('test succeeds when username and password are valid', async() => {
    const validUser = {
      username: 'jdoe',
      name: 'John Doe',
      password: 'salainen'
  ...
  test('when username is missing, return error 400', async() => {
    const invalidUser = {
      name: 'John Doe',
      password: 'salainen'
    }
  ...
  test('when username is lesser than 3 characters, return error 400', async() => {
    const invalidUser = {
      username: 'jd',
      name: 'John Doe',
      password: 'salainen'
  ...
  test('when username already exists, return error 400', async() => {
    const invalidUser = {
      username: 'root',
      name: 'John Doe',
      password: 'salainen'
  ...
  test('when password is missing, return error 400', async() => {
    const invalidUser = {
      username: 'jdoe',
      name: 'John Doe'
    }
  ...
  test('when password is less than 3 characters long, return error 400', async() => {
    const invalidUser = {
      username: 'jdoe',
      name: 'John Doe',
      password: 'sa'
